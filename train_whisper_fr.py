#!/usr/bin/env python3
"""
Fine-tuning script for OpenAI Whisper Large V3
Optimized for French transcription and long-form conversations/meetings
"""
...
OUTPUT_DIR = "./gilbert-whisper-large-v3-fr-v1"
SAMPLING_RATE = 16000
...
DATASETS_CONFIG = [
    ...
    },
    {
        ...
        "config": "fr",
        "text_column": None,  # Will detect normalized_text or raw_text
        "audio_column": "audio",
    },
]
...
def main():
    ...
    # For fine-tuning, we don't force specific decoder IDs
